export const faq = [
     ...
     },
     {
          ...
          ans: [
               `We offer the option to lease the necessary 
               devices for connectivity, namely the Radio and Access points. This approach is 
               intended to make the overall installation cost more affordable. `,
               
               `The monthly  installment payment for the leased devices is set at 5,000. This amount will 
               continue until you have fully paid off the device, with the total cost remaining the 
               same. `,
               
               `Alternatively, if you prefer, you have the option to make an outright 
               payment. ` ,
